...
<body class="p-4 md:p-8">
        ...
        <div class="mb-6 flex justify-center">
            <div class="relative w-full max-w-md">
                <input
                    ...
                    class="w-full px-5 py-3 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-indigo-400 outline-none shadow-sm text-sm">
    ...
    <script>
        ...
        function showToast(message = "Tidak ditemukan 😢") {
        ...
        // 🔥 AUTO EXPAND SEMUA NODE
        function expandAllNodes() {
            let switches = document.querySelectorAll('.collapse-switch');
            ...
            // 🔁 ulangi sampai tidak ada lagi yang collapsed
            setTimeout(() => {
                let stillCollapsed = document.querySelectorAll('.node.collapsed');
        ...
        document.getElementById('searchInput').addEventListener('input', function() {
            ...
            // 🔥 STEP 1: Expand semua dulu (WAJIB untuk Treant)
            expandAllNodes();

            setTimeout(() => {
                const nodesAfterExpand = document.querySelectorAll('.node');

                let found = false;
                let firstMatch = null;

                nodesAfterExpand.forEach(node => {
                ...
                // 🔥 STEP 2: Fokus ke hasil saja (optional hide lain)
                focusToMatched(nodesAfterExpand);
...
<div id="toast" class="fixed bottom-6 left-1/2 -translate-x-1/2 px-6 py-3 bg-slate-900 text-white text-sm rounded-xl shadow-lg opacity-0 pointer-events-none transition-all duration-300">
    Tidak ditemukan 😢
</div>
